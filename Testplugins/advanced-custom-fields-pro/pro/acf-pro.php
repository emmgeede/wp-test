	...
	class acf_pro {
		...
		public function maybe_show_license_status_error() {
			...
			if ( ! acf_pro_get_license_key( true ) && ! defined( 'ACF_PRO_LICENSE' ) ) {
				$error_msg  = __( 'Activate your license to enable access to support &amp; PRO features.', 'acf' );
				...
				$error_msg  = __( 'Your license has expired. Please renew to continue to have access support &amp; PRO features.', 'acf' );
				...
				$error_msg  = __( 'Your ACF PRO license is no longer active. Please renew to continue to have access to support, & PRO features.', 'acf' );
				$manage_url = admin_url( 'edit.php?post_type=acf-field-group&page=acf-settings-updates' );
