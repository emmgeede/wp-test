...
class FlexibleContentField extends AbstractField
{
	...
	public function render()
	{
        ...
        $addLabel = $this->getAdvancedOption('add_label');
        $deleteLabel = $this->getAdvancedOption('remove_label');
		...
		$field .= $this->blocksList($blocksListId, $minimumBlocks, $maximumBlocks, $layout, $leadingFieldId, $addLabel, $deleteLabel);
	 ...
	 * @throws \Exception
	 */
	private function blocksList($blocksListId, $minimumBlocks = null, $maximumBlocks = null, $layout = 'row', $leadingFieldId = null, $addLabel = null, $deleteLabel = null)
	{
	...
	private function addButton($blocksListId, $layout)
	{
		...
		$minimumBlocks = $this->getAdvancedOption('minimum_blocks');
		$maximumBlocks = $this->getAdvancedOption('maximum_blocks');
        $leadingField = $this->getAdvancedOption('leading_field');
        $addLabel = $this->getAdvancedOption('add_label');
        $deleteLabel = $this->getAdvancedOption('remove_label');
		...
		foreach ($this->metaField->getBlocks() as $block){
			...
			$button .= '<li 
					...
					data-leading-field="'.$leadingField.'"
        ...
        $button .= AbstractField::keyboardShortcutsLegend('margin-top: 0;');
