...
export const CSVToArray = (strData) => {
    ...
    const strDelimiters = guessDelimiters(strData, supportedDelimiters);

    if(strDelimiters.length !== 1){
        throw new Error(`Delimiter was not recognized`);
    }

    const strDelimiter = strDelimiters[0];
