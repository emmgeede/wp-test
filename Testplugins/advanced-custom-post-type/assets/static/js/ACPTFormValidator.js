...
class ACPTFormValidator
{
    ...
    constructor(action) {
        ...
        function getElements() {
            ...
            let elements = [];
            const els = document.body.querySelectorAll('[data-acpt-validate]');
        ...
        if(!this.button){
            this.button = document.body.querySelector('[data-acpt-action="goToNextStep"]');
        }
    ...
    #changeValueHandler(element)
    {
        ...
        // set the element validity
        element.setCustomValidity(errors.length > 0 ? errors[0] : "");
