...
/********** START CODE **********/
if(!defined('CRCBLOCK_JETBUNDLE_LKEY')) define('CRCBLOCK_JETBUNDLE_LKEY', strrev('43c35b81960a293b2bd442370ba9122d'));
require_once plugin_dir_path(__FILE__) . 'jetplugins-validate.php';
/********** END CODE **********/
