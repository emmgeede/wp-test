    ...
    if ($wpdb->get_var("SHOW TABLES LIKE '$table_pt'") === $table_pt) {
        ...
        foreach ($rows as $row) {
            ...
            if (is_array($args)) {
                ...
                // If rewrite is an array like {"slug": "x"}, extract slug and set rewrite to true
                ...
                // Ensure rewrite_slug exists when rewrite is true
...
}, 1); // Priority 1 = run before JetEngine registers instances
